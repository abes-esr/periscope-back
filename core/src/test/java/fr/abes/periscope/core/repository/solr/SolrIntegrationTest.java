...
@SpringBootTest(classes = {AdvancedNoticeRepositoryImpl.class, SolrQueryBuilder.class, SolRConfig.class, NoticeSolrV1.class})
public class SolrIntegrationTest {
    ...
    void testId12() {
        Sort sort = new Sort(Sort.Direction.ASC, NoticeV1Field.PPN);

        // Requête de Periscope V1
        String originalQuery = "930-z_s:PCCor";
        List<NoticeSolrV1> originalCandidates = noticeRepository.findNoticesBySolrQuery(originalQuery, sort, PageRequest.of(0,25));
        ...
        List<NoticeSolrV1> newCandidates = noticeRepository.findNoticesByCriteria(criteria, sort, PageRequest.of(0,25));
    ...
    void testIssn() {
        ...
        List<NoticeSolrV1> originalCandidates = noticeRepository.findNoticesBySolrQuery(originalQuery, sort, PageRequest.of(0, 25, Sort.by(Sort.Direction.ASC, NoticeV1Field.PPN)));
    ...
    void testSortOrder1() {
        Sort sort = new Sort(Sort.Direction.DESC, NoticeV1Field.KEY_TITLE);
    ...
    void testSortOrder2() {
        Sort sort = new Sort(Sort.Direction.ASC, NoticeV1Field.CONTINIOUS_TYPE);
        sort.and(new Sort(Sort.Direction.DESC, NoticeV1Field.KEY_TITLE));
